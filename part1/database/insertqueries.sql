...
((SELECT dog_id FROM Dogs WHERE name='Kevin'), '2025-06-08 11:00:00', 50, '', 'cancelled'),
((SELECT dog_id FROM Dogs WHERE name='Kevin'), '2025-06-12 10:00:00', 30, 'Henley Beach', 'cancelled'),
